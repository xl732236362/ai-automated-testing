...
class TestWebConsoleStatic(unittest.TestCase):
    ...
    def test_index_wires_assets_and_sample_data(self):
        ...
        self.assertIn('id="allow-continuous-actions-input"', html)
    ...
    def test_app_declares_static_only_boundary(self):
        ...
        self.assertIn("getContinuousActionsEnabled", script)
        self.assertIn("getEffectiveAllowedActions", script)
        self.assertIn("wireUnsafeActionToggle", script)
        self.assertIn("wireContinuousActionToggle", script)
        ...
        self.assertRegex(script, r"enable_continuous_actions:\s*getContinuousActionsEnabled\(\)")
        self.assertIn('const UNSAFE_ACTIONS = ["tap", "swipe", "hold_drag_release"];', script)
        self.assertIn('const CONTINUOUS_ACTIONS = ["aim_fire"];', script)
        self.assertIn("aim_fire", script)
